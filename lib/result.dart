              ...
              children: [
                Container(
                  ...
                  child: FAProgressBar(
                    ...
                    displayTextStyle: TextStyle(color: Colors.black,fontSize: 30),
                  ) ,
                ),
                Container(
                    ...
                    children: [
                      Container(
                        ...
                        child: FlatButton(onPressed: ()
                            ...
                            child: Text('Check Wrong Q',style:TextStyle(color: Colors.black,fontSize: 20,fontStyle: FontStyle.normal),)
                      ...
                      Container(
                        ...
                        child: FlatButton(onPressed: ()
                            ...
                            child: Text('RETAKE QUIZ',style:TextStyle(color: Colors.black,fontSize: 20,fontStyle: FontStyle.normal),)
