              ...
              Container(
                ...
                {if(Q==wrongq.length)
                    ...
                    Alert(
                      ...
                      buttons: [
                        DialogButton(
                          ...
                          onPressed: () =>  Navigator.push(context, MaterialPageRoute(builder: (context)=>QuizApp())),
                          width: 150,
                        )
                      ],
                    ).show();
                  ...
                  setState(() {
                    ...
                    child: Text('Next Question',style:TextStyle(color: Colors.black,fontSize: 20,fontStyle: FontStyle.normal),)
